# Generated by Powerlevel10k configuration wizard on 2025-07-28 at 17:54 IST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%223F'  # cream foreground (branch)
      local   modified='%214F'  # bright orange foreground
      local  untracked='%166F'  # orange foreground
