...
# Screenshot Filename
source ~/.config/misc/settings/screenshot-filename.sh

# Screenshot Folder
source ~/.config/misc/settings/screenshot-folder.sh

# Screenshot Editor
export GRIMBLAST_EDITOR="$(cat ~/.config/misc/settings/screenshot-editor.sh)"
