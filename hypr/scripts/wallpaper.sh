...
if [ -f ~/.config/misc/settings/wallpaper_cache ]; then
  use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/misc/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/misc/cache/waypaper-running
cachefile="$HOME/.config/misc/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/misc/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/misc/cache/square_wallpaper.png"
rasifile="$HOME/.config/misc/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/misc/settings/blur.sh"
defaultwallpaper="$HOME/wallpaper/default.jpg"
wallpapereffect="$HOME/.config/misc/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
