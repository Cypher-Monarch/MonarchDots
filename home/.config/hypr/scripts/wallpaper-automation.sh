...
sec=$(cat ~/.config/misc/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/misc/cache/wallpaper-automation ]; then
    touch ~/.config/misc/cache/wallpaper-automation
    ...
    rm ~/.config/misc/cache/wallpaper-automation
